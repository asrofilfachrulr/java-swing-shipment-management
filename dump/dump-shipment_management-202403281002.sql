...
INSERT INTO `cities` VALUES (1,'Jakarta',0,'JKT'),(6,'Bandung',2,'BDG'),(8,'Semarang',6,'SME'),(9,'Surabaya',10,'SBY'),(16,'Medan',-8,'ME');
...
INSERT INTO `delivery_requests` VALUES (5,'Asrofil','0822','Jl. Jalan Jalan','Fachrul','1200','Jl, Leumpang',1.2,1,'Cilok',19000,'2024-03-26 01:58:15',6,1,6,'2024-03-27 09:30:00','2024-03-27 10:30:00',0),(6,'Asrofil','0822','Jl. Sukabumi','Fachrul','0812','Jl. Bumisuka',3.6,1,'Kipas Angin',33000,'2024-03-26 10:11:09',6,1,8,NULL,NULL,1),(7,'Asrofil','0852','Jl. Soehat','Riidlo','0856','Jl. Sudirman',2.1,1,'Laptop',37000,'2024-03-26 10:13:23',6,6,16,NULL,NULL,0),(8,'Dummy','0821','Jl. Dummy','John Doe','0823','Jl. Doe',1.2,0,'This is a dummy desc',17000,'2024-03-27 00:18:40',1,8,1,NULL,NULL,0),(9,'Asrofil','0822','Jl. Otto Iskandar','Anya','0812','Jl. Merdeka',2.1,1,'Mixer 20W',37000,'2024-03-27 09:45:00',6,1,9,'2024-03-27 11:42:00','2024-03-27 12:11:00',0);
...
INSERT INTO `office_types` VALUES (1,'HUB','HUB'),(2,'WAREHOUSE','WH'),(3,'DROP CENTER','DC');
...
CREATE TABLE `package_deliveries` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `package_deliveries_unique` (`delivery_req_id`),
...
INSERT INTO `package_deliveries` VALUES (1,'DELIVERED',9,3),(2,'IN PROGRESS',5,3);
...
INSERT INTO `package_histories` VALUES (2,'2024-03-27 15:30:00','RECEIVED','JKT Hub','Package has been received',1,3),(3,'2024-03-27 21:30:00','DEPARTED','JKT Hub','Package has been departed to local Warehouse',1,3),(4,'2024-03-27 23:00:00','RECEIVED','JKT WH','Package has been received at local Warehouse',1,2),(5,'2024-03-27 23:45:00','DEPARTED','JKT WH','Package has been departed to local Drop Center',1,2),(6,'2024-03-27 23:58:00','RECEIVED','JKT DC','Package has been received at local Drop Center',1,7),(7,'2024-03-28 02:10:00','DEPARTED','JKT DC','Package has been departed to other Drop Center',1,7),(8,'2024-03-28 09:15:00','RECEIVED','SEM DC','Package has been received to local Drop Center',1,13),(9,'2024-03-28 17:36:00','DEPARTED','SEM DC','Package has been departed to other Drop Center',1,13),(10,'2024-03-28 23:49:00','RECEIVED','SBY DC','Package has been received at local Drop Center',1,16),(11,'2024-03-29 01:32:00','DEPARTED','SBY DC','Package has been departed to local Warehouse',1,16),(12,'2024-03-29 02:10:00','RECEIVED','SBY WH','Package has been received at local Warehouse',1,15),(13,'2024-03-29 02:56:00','DEPARTED','SBY WH','Package has been departed to local Hub',1,15),(14,'2024-03-29 04:20:00','RECEIVED','SBY HUB','Package has been received at local Hub',1,14),(15,'2024-03-29 09:45:00','DEPARTED','SBY HUB','Package has been departed to recipient',1,14),(16,'2024-03-29 13:57:00','RECEIVED','RECIPIENT','Package has been received by recipient',1,14),(17,'2024-03-28 05:54:06','RECEIVED','JKT HUB','Package has been received',2,3);
...
-- Dump completed on 2024-03-28 10:02:45
