...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `customers_unique` (`email`,`phone`,`username`)
...
INSERT INTO `customers` VALUES (1,'dummy@sms.id','112','customer dummy','-','b5a2c96250612366ea272ffac6d9744aaf4b45aacd96aa7cfcb931ee3b558259','dummy');
...
CREATE TABLE `delivery_requests` (
  ...
  `stuff_description` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2024-03-23 11:00:17
